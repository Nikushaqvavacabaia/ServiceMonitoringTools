...
<br><br><br><br>
		...
		<section id="s-team" class="section">
			...
			<br><br><br>
            <?php 
            $sumofprov=($sumbogmay + $sumtbcmay + $sumoppamay + $sumipaymay + $sumtbcpaymay + $sumnovapaymentsmay + $sumegtmay + $sumeverymatrixmay + $sumoppamay + $sumbetconstructmay + $sumbetradarmay + $sumgoldenracemay + $sumevolutiongamingmay + $sumlambdamay + $sumigrosoftmay +  $sumsilknetmay + $summagtimay + $sumglobalcellmay + $sumcaucasusmay + $sumlivecallermay);
            $sumofnetwork=$sumitsupportmay;
            $sumofback=$sumsbbettingmay;
            $sumoffront=$sumfrontmay;
