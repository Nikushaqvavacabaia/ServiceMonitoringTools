...
<br><br><br><br>
		...
		<section id="s-team" class="section">
			...
			<br><br><br>
            <?php 
            $sumofprov=($sumbogsep + $sumtbcsep + $sumoppasep + $sumipaysep + $sumtbcpaysep + $sumnovapaymentssep + $sumegtsep + $sumeverymatrixsep + $sumoppasep + $sumbetconstructsep + $sumbetradarsep + $sumgoldenracesep + $sumevolutiongamingsep + $sumlambdasep + $sumigrosoftsep +  $sumsilknetsep + $summagtisep + $sumglobalcellsep + $sumcaucasussep + $sumlivecallersep);
            $sumofnetwork=$sumitsupportsep;
            $sumofback=$sumsbbettingsep;
            $sumoffront=$sumfrontsep;
