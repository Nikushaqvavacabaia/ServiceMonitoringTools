...
<body>
									...
									<td>  
										<?php
											...
											if($date2 < $date1){
												...
												array_push($silknetjanall, $date4);
												echo($date4);
												
											}
											else{
												array_push($silknetjanall, (float)$diff->format("%h.%i"));
	...
	<script type="text/javascript">
		...
		alertAudio.play();
		alert("All Problems of Silknet January --> " + {{$counter}} + "\nSum of time Silknet January Problems --> " + {{array_sum($silknetjanall)}} + " Hour")
