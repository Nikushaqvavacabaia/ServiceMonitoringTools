...
<br><br><br><br>
		...
		<section id="s-team" class="section">
			...
			<br><br><br>
            <?php 
            $sumofprov=($sumbogdec + $sumtbcdec + $sumoppadec + $sumipaydec + $sumtbcpaydec + $sumdecapaymentsdec + $sumegtdec + $sumeverymatrixdec + $sumoppadec + $sumbetconstructdec + $sumbetradardec + $sumgoldenracedec + $sumevolutiongamingdec + $sumlambdadec + $sumigrosoftdec +  $sumsilknetdec + $summagtidec + $sumglobalcelldec + $sumcaucasusdec + $sumlivecallerdec);
