...
<br><br><br><br>
		...
		<section id="s-team" class="section">
			...
			<br><br><br>
            <?php 
            $sumofprov=($sumbogjan + $sumtbcjan + $sumoppajan + $sumipayjan + $sumtbcpayjan + $sumnovapaymentsjan + $sumegtjan + $sumeverymatrixjan + $sumoppajan + $sumbetconstructjan + $sumbetradarjan + $sumgoldenracejan + $sumevolutiongamingjan + $sumlambdajan + $sumigrosoftjan +  $sumsilknetjan + $summagtijan + $sumglobalcelljan + $sumcaucasusjan + $sumlivecallerjan);
            $sumofnetwork=$sumitsupportjan;
            $sumofback=$sumsbbettingjan;
            $sumoffront=$sumfrontjan;
