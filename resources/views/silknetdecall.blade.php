...
<body>
									...
									<td>  
										<?php
											...
											if($date2 < $date1){
												...
												array_push($silknetdecall, $date4);
												echo($date4);
												
											}
											else{
												array_push($silknetdecall, (float)$diff->format("%h.%i"));
	...
	<script type="text/javascript">
		...
		alertAudio.play();
		alert("All Problems of Silknet December --> " + {{$counter}} + "\nSum of time Silknet December Problems --> " + {{array_sum($silknetdecall)}} + " Hour")
