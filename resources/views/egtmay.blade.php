...
<body>
    ...
    <div class="productBody">
        <div class="product1">
            <a class="provider_link" href="/egtmayall">
                <h1 class="product1Header">EGT - Issues in HH/MM: {{$sumegtmay}}</h1>
            </a>

            <div class="graph">
            <a href="/egt1may" class="egt1a">
            <button class="box" id="egt1"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext"> {{$lst}}-01 Problem in HH/MM: {{ $egt1maycount }}</span>
                ...
                if ($egt1maycount>=0.10 && $egt1maycount<=0.20){
                    echo "<style>#egt1{
            ...
            <a href="/egt2may" class="egt2a">
            <button class="box" id="egt2"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-02 Problem in HH/MM: {{ $egt2maycount }}</span>
                ...
                if ($egt2maycount >=0.10 && $egt2maycount<=0.20){
                    echo "<style>#egt2{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt3may" class="egt3a">
            <button class="box" id="egt3"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-03 Problem in HH/MM: {{ $egt3maycount }}</span>
                ...
                if ($egt3maycount>=0.10 && $egt3maycount<=0.20){
                    echo "<style>#egt3{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt4may" class="egt4a">
            <button class="box" id="egt4"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-04 Problem in HH/MM: {{ $egt4maycount }}</span>
                ...
                if ($egt4maycount>=0.10 && $egt4maycount<=0.20){
                    echo "<style>#egt4{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt5may" class="egt5a">
            <button class="box" id="egt5"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-05 Problem in HH/MM: {{ $egt5maycount }}</span>
                ...
                if ($egt5maycount>=0.10 && $egt5maycount<=0.20){
                    echo "<style>#egt5{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt6may" class="egt6a">
            <button class="box" id="egt6"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-06 Problem in HH/MM: {{ $egt6maycount }}</span>
                ...
                if ($egt6maycount>=0.10 && $egt6maycount<=0.20){
                    echo "<style>#egt6{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt7may" class="egt7a">
            <button class="box" id="egt7"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-07 Problem in HH/MM: {{ $egt7maycount }}</span>
                ...
                if ($egt7maycount>=0.10 && $egt7maycount<=0.20){
                    echo "<style>#egt7{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt8may" class="egt8a">
            <button class="box" id="egt8"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-08 Problem in HH/MM: {{ $egt8maycount }}</span>
                ...
                if ($egt8maycount>=0.10 && $egt8maycount<=0.20){
                    echo "<style>#egt8{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt9may" class="egt9a">
            <button class="box" id="egt9"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-09 Problem in HH/MM: {{ $egt9maycount }}</span>
                ...
                if ($egt9maycount>=0.10 && $egt9maycount<=0.20){
                    echo "<style>#egt9{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt10may" class="egt10a">
            <button class="box" id="egt10"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-10 Problem in HH/MM: {{ $egt10maycount }}</span>
                ...
                if ($egt10maycount>=0.10 && $egt10maycount<=0.20){
                    echo "<style>#egt10{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt11may" class="egt11a">
            <button class="box" id="egt11"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-11 Problem in HH/MM: {{ $egt11maycount }}</span>
                ...
                if ($egt11maycount>=0.10 && $egt11maycount<=0.20){
                    echo "<style>#egt11{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt12may" class="egt12a">
            <button class="box" id="egt12"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-12 Problem in HH/MM: {{ $egt12maycount }}</span>
                ...
                if ($egt12maycount>=0.10 && $egt12maycount<=0.20){
                    echo "<style>#egt12{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt13may" class="egt13a">
            <button class="box" id="egt13"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-13 Problem in HH/MM: {{ $egt13maycount }}</span>
                ...
                if ($egt13maycount>=0.10 && $egt13maycount<=0.20){
                    echo "<style>#egt13{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt14may" class="egt14a">
            <button class="box" id="egt14"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-14 Problem in HH/MM: {{ $egt14maycount }}</span>
                ...
                if ($egt14maycount>=0.10 && $egt14maycount<=0.20){
                    echo "<style>#egt14{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt15may" class="egt15a">
            <button class="box" id="egt15"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-15 Problem in HH/MM: {{ $egt15maycount }}</span>
                ...
                if ($egt15maycount>=0.10 && $egt15maycount<=0.20){
                    echo "<style>#egt15{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt16may" class="egt16a">
                <button class="box" id="egt16"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-16 Problem in HH/MM: {{ $egt16maycount }}</span>
                ...
                if ($egt16maycount>=0.10 && $egt16maycount<=0.20){
                    echo "<style>#egt16{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt17may" class="egt17a">
            <button class="box" id="egt17"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-17 Problem in HH/MM: {{ $egt17maycount }}</span>
                ...
                if ($egt17maycount>=0.10 && $egt17maycount<=0.20){
                    echo "<style>#egt17{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt18may" class="egt18a">
            <button class="box" id="egt18"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-18 Problem in HH/MM: {{ $egt18maycount }}</span>
                ...
                if ($egt18maycount>=0.10 && $egt18maycount<=0.20){
                    echo "<style>#egt18{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt19may" class="egt19a">
            <button class="box" id="egt19"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-19 Problem in HH/MM: {{ $egt19maycount }}</span>
                ...
                if ($egt19maycount>=0.10 && $egt19maycount<=0.20){
                    echo "<style>#egt19{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt20may" class="egt20a">
            <button class="box" id="egt20"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-20 Problem in HH/MM: {{ $egt20maycount }}</span>
                ...
                if ($egt20maycount>=0.10 && $egt20maycount<=0.20){
                    echo "<style>#egt20{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt21may" class="egt21a">
            <button class="box" id="egt21"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-21 Problem in HH/MM: {{ $egt21maycount }}</span>
                ...
                if ($egt21maycount>=0.10 && $egt21maycount<=0.20){
                    echo "<style>#egt21{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt22may" class="egt22a">
            <button class="box" id="egt22"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-22 Problem in HH/MM: {{ $egt22maycount }}</span>
                ...
                if ($egt22maycount>=0.10 && $egt22maycount<=0.20){
                    echo "<style>#egt22{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt23may" class="egt23a">
            <button class="box" id="egt23"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-23 Problem in HH/MM: {{ $egt23maycount }}</span>
                ...
                if ($egt23maycount>=0.10 && $egt23maycount<=0.20){
                    echo "<style>#egt23{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt24may" class="egt24a">
            <button class="box" id="egt24"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-24 Problem in HH/MM: {{ $egt24maycount }}</span>
                ...
                if ($egt24maycount>=0.10 && $egt24maycount<=0.20){
                    echo "<style>#egt24{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt25may" class="egt25a">
            <button class="box" id="egt25"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-25 Problem in HH/MM: {{ $egt25maycount }}</span>
                ...
                if ($egt25maycount>=0.10 && $egt25maycount<=0.20){
                    echo "<style>#egt25{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt26may" class="egt26a">
            <button class="box" id="egt26"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-26 Problem in HH/MM: {{ $egt26maycount }}</span>
                ...
                if ($egt26maycount>=0.10 && $egt26maycount<=0.20){
                    echo "<style>#egt26{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt27may" class="egt27a">
            <button class="box" id="egt27"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-27 Problem in HH/MM: {{ $egt27maycount }}</span>
                ...
                if ($egt27maycount>=0.10 && $egt27maycount<=0.20){
                    echo "<style>#egt27{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt28may" class="egt28a">
            <button class="box" id="egt28"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-28 Problem in HH/MM: {{ $egt28maycount }}</span>
                ...
                if ($egt28maycount>=0.10 && $egt28maycount<=0.20){
                    echo "<style>#egt28{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt29may" class="egt29a">
            <button class="box" id="egt29"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-29 Problem in HH/MM: {{ $egt29maycount }}</span>
                ...
                if ($egt29maycount>=0.10 && $egt29maycount<=0.20){
                    echo "<style>#egt29{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt30may" class="egt30a">
            <button class="box" id="egt30"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-30 Problem in HH/MM: {{ $egt30maycount }}</span>
                ...
                if ($egt30maycount>=0.10 && $egt30maycount<=0.20){
                    echo "<style>#egt30{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt31may" class="egt31a">
            <button class="box" id="egt31"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-31 Problem in HH/MM: {{ $egt31maycount }}</span>
                ...
                if ($egt31maycount>=0.10 && $egt31maycount<=0.20){
                    echo "<style>#egt31{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
