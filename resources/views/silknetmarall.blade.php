...
<body>
									...
									<td>  
										<?php
											...
											if($date2 < $date1){
												...
												array_push($silknetmarall, $date4);
												echo($date4);
												
											}
											else{
												array_push($silknetmarall, (float)$diff->format("%h.%i"));
	...
	<script type="text/javascript">
		...
		alertAudio.play();
		alert("All Problems of Silknet March --> " + {{$counter}} + "\nSum of time Silknet March Problems --> " + {{array_sum($silknetmarall)}} + " Hour")
