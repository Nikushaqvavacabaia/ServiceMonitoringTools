...
<body>
    ...
    <div class="productBody">
        <div class="product1">
            <a class="provider_link" href="/tbcdecall">
                <h1 class="productHeader">UFC(TBC) - Issues in HH/MM: {{$sumtbcdec}}</h1>
            </a>
            <div class="graph">
            <a href="/tbc1dec" class="tbc1a">
            <button class="box" id="tbc1"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-01 Problem in HH/MM: {{ $tbc1deccount }}</span>
                ...
                if ($tbc1deccount>=0.10 && $tbc1deccount<=0.20){
                    echo "<style>#tbc1{
            ...
            <a href="/tbc2dec" class="tbc2a">
            <button class="box" id="tbc2"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-02 Problem in HH/MM: {{ $tbc2deccount }}</span>
                ...
                if ($tbc2deccount>=0.10 && $tbc2deccount<=0.20){
                    echo "<style>#tbc2{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc3dec" class="tbc3a">
            <button class="box" id="tbc3"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-03 Problem in HH/MM: {{ $tbc3deccount }}</span>
                ...
                if ($tbc3deccount>=0.10 && $tbc3deccount<=0.20){
                    echo "<style>#tbc3{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc4dec" class="tbc4a">
            <button class="box" id="tbc4"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-04 Problem in HH/MM: {{ $tbc4deccount }}</span>
                ...
                if ($tbc4deccount>=0.10 && $tbc4deccount<=0.20){
                    echo "<style>#tbc4{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc5dec" class="tbc5a">
            <button class="box" id="tbc5"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-05 Problem in HH/MM: {{ $tbc5deccount }}</span>
                ...
                if ($tbc5deccount>=0.10 && $tbc5deccount<=0.20){
                    echo "<style>#tbc5{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc6dec" class="tbc6a">
            <button class="box" id="tbc6"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-06 Problem in HH/MM: {{ $tbc6deccount }}</span>
                ...
                if ($tbc6deccount>=0.10 && $tbc6deccount<=0.20){
                    echo "<style>#tbc6{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc7dec" class="tbc7a">
            <button class="box" id="tbc7"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-07 Problem in HH/MM: {{ $tbc7deccount }}</span>
                ...
                if ($tbc7deccount>=0.10 && $tbc7deccount<=0.20){
                    echo "<style>#tbc7{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc8dec" class="tbc8a">
            <button class="box" id="tbc8"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-08 Problem in HH/MM: {{ $tbc8deccount }}</span>
                ...
                if ($tbc8deccount>=0.10 && $tbc8deccount<=0.20){
                    echo "<style>#tbc8{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc9dec" class="tbc9a">
            <button class="box" id="tbc9"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-09 Problem in HH/MM: {{ $tbc9deccount }}</span>
                ...
                if ($tbc9deccount>=0.10 && $tbc9deccount<=0.20){
                    echo "<style>#tbc9{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc10dec" class="tbc10a">
            <button class="box" id="tbc10"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-10 Problem in HH/MM: {{ $tbc10deccount }}</span>
                ...
                if ($tbc10deccount>=0.10 && $tbc10deccount<=0.20){
                    echo "<style>#tbc10{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc11dec" class="tbc11a">
            <button class="box" id="tbc11"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-11 Problem in HH/MM: {{ $tbc11deccount }}</span>
                ...
                if ($tbc11deccount>=0.10 && $tbc11deccount<=0.20){
                    echo "<style>#tbc11{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc12dec" class="tbc12a">
            <button class="box" id="tbc12"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-12 Problem in HH/MM: {{ $tbc12deccount }}</span>
                ...
                if ($tbc12deccount>=0.10 && $tbc12deccount<=0.20){
                    echo "<style>#tbc12{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc13dec" class="tbc13a">
            <button class="box" id="tbc13"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-13 Problem in HH/MM: {{ $tbc13deccount }}</span>
                ...
                if ($tbc13deccount>=0.10 && $tbc13deccount<=0.20){
                    echo "<style>#tbc13{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc14dec" class="tbc14a">
            <button class="box" id="tbc14"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-14 Problem in HH/MM: {{ $tbc14deccount }}</span>
                ...
                if ($tbc14deccount>=0.10 && $tbc14deccount<=0.20){
                    echo "<style>#tbc14{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc15dec" class="tbc15a">
            <button class="box" id="tbc15"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-15 Problem in HH/MM: {{ $tbc15deccount }}</span>
                ...
                if ($tbc15deccount>=0.10 && $tbc15deccount<=0.20){
                    echo "<style>#tbc15{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc16dec" class="tbc16a">
            <button class="box" id="tbc16"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-16 Problem in HH/MM: {{ $tbc16deccount }}</span>
                ...
                if ($tbc16deccount>=0.10 && $tbc16deccount<=0.20){
                    echo "<style>#tbc16{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc17dec" class="tbc17a">
            <button class="box" id="tbc17"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-17 Problem in HH/MM: {{ $tbc17deccount }}</span>
                ...
                if ($tbc17deccount>=0.10 && $tbc17deccount<=0.20){
                    echo "<style>#tbc17{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc18dec" class="tbc18a">
            <button class="box" id="tbc18"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-18 Problem in HH/MM: {{ $tbc18deccount }}</span>
                ...
                if ($tbc18deccount>=0.10 && $tbc18deccount<=0.20){
                    echo "<style>#tbc18{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc19dec" class="tbc19a">
            <button class="box" id="tbc19"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-19 Problem in HH/MM: {{ $tbc19deccount }}</span>
                ...
                if ($tbc19deccount>=0.10 && $tbc19deccount<=0.20){
                    echo "<style>#tbc19{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc20dec" class="tbc20a">
            <button class="box" id="tbc20"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-20 Problem in HH/MM: {{ $tbc20deccount }}</span>
                ...
                if ($tbc20deccount>=0.10 && $tbc20deccount<=0.20){
                    echo "<style>#tbc20{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc21dec" class="tbc21a">
            <button class="box" id="tbc21"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-21 Problem in HH/MM: {{ $tbc21deccount }}</span>
                ...
                if ($tbc21deccount>=0.10 && $tbc21deccount<=0.20){
                    echo "<style>#tbc21{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc22dec" class="tbc22a">
            <button class="box" id="tbc22"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-22 Problem in HH/MM: {{ $tbc22deccount }}</span>
                ...
                if ($tbc22deccount>=0.10 && $tbc22deccount<=0.20){
                    echo "<style>#tbc22{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc23dec" class="tbc23a">
            <button class="box" id="tbc23"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-23 Problem in HH/MM: {{ $tbc23deccount }}</span>
                ...
                if ($tbc23deccount>=0.10 && $tbc23deccount<=0.20){
                    echo "<style>#tbc23{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc24dec" class="tbc24a">
            <button class="box" id="tbc24"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-24 Problem in HH/MM: {{ $tbc24deccount }}</span>
                ...
                if ($tbc24deccount>=0.10 && $tbc24deccount<=0.20){
                    echo "<style>#tbc24{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc25dec" class="tbc25a">
            <button class="box" id="tbc25"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-25 Problem in HH/MM: {{ $tbc25deccount }}</span>
                ...
                if ($tbc25deccount>=0.10 && $tbc25deccount<=0.20){
                    echo "<style>#tbc25{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc26dec" class="tbc26a">
            <button class="box" id="tbc26"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-26 Problem in HH/MM: {{ $tbc26deccount }}</span>
                ...
                if ($tbc26deccount>=0.10 && $tbc26deccount<=0.20){
                    echo "<style>#tbc26{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc27dec" class="tbc27a">
            <button class="box" id="tbc27"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-27 Problem in HH/MM: {{ $tbc27deccount }}</span>
                ...
                if ($tbc27deccount>=0.10 && $tbc27deccount<=0.20){
                    echo "<style>#tbc27{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc28dec" class="tbc28a">
            <button class="box" id="tbc28"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-28 Problem in HH/MM: {{ $tbc28deccount }}</span>
                ...
                if ($tbc28deccount>=0.10 && $tbc28deccount<=0.20){
                    echo "<style>#tbc28{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc29dec" class="tbc29a">
            <button class="box" id="tbc29"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-29 Problem in HH/MM: {{ $tbc29deccount }}</span>
                ...
                if ($tbc29deccount>=0.10 && $tbc29deccount<=0.20){
                    echo "<style>#tbc29{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc30dec" class="tbc30a">
            <button class="box" id="tbc30"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-30 Problem in HH/MM: {{ $tbc30deccount }}</span>
                ...
                if ($tbc30deccount>=0.10 && $tbc30deccount<=0.20){
                    echo "<style>#tbc30{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
			...
			<a href="/tbc31dec" class="tbc31a">
            <button class="box" id="tbc31"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-31 Problem in HH/MM: {{ $tbc31deccount }}</span>
                ...
                if ($tbc31deccount>=0.10 && $tbc31deccount<=0.20){
                    echo "<style>#tbc31{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
