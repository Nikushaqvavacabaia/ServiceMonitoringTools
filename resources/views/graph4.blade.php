...
<br><br><br><br>
		...
		<section id="s-team" class="section">
			...
			<br><br><br>
            <?php 
            $sumofprov=($sumbogapr + $sumtbcapr + $sumoppaapr + $sumipayapr + $sumtbcpayapr + $sumnovapaymentsapr + $sumegtapr + $sumeverymatrixapr + $sumoppaapr + $sumbetconstructapr + $sumbetradarapr + $sumgoldenraceapr + $sumevolutiongamingapr + $sumlambdaapr + $sumigrosoftapr +  $sumsilknetapr + $summagtiapr + $sumglobalcellapr + $sumcaucasusapr + $sumlivecallerapr);
            $sumofnetwork=$sumitsupportapr;
            $sumofback=$sumsbbettingapr;
            $sumoffront=$sumfrontapr;
