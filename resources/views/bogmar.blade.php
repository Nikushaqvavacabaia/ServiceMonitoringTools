...
<body>
    ...
    <div class="productBody">
        <div class="product1">
            <a class="provider_link" href="/bogmarall">
                <h1 class="product1Header">GC (BOG) - Issues in HH/MM: {{$sumbogmar}}</h1>
            </a>

            <div class="graph">
            <a href="/bog1mar" class="bog1a">
            <button class="box" id="bog1"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext"> {{$lst}}-01 Problem in HH/MM: {{ $bog1marcount }}</span>
                ...
                if ($bog1marcount>=0.10 && $bog1marcount<=0.20){
                    echo "<style>#bog1{
            ...
            <a href="/bog2mar" class="bog2a">
            <button class="box" id="bog2"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-02 Problem in HH/MM: {{ $bog2marcount }}</span>
                ...
                if ($bog2marcount >=0.10 && $bog2marcount<=0.20){
                    echo "<style>#bog2{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog3mar" class="bog3a">
            <button class="box" id="bog3"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-03 Problem in HH/MM: {{ $bog3marcount }}</span>
                ...
                if ($bog3marcount>=0.10 && $bog3marcount<=0.20){
                    echo "<style>#bog3{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog4mar" class="bog4a">
            <button class="box" id="bog4"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-04 Problem in HH/MM: {{ $bog4marcount }}</span>
                ...
                if ($bog4marcount>=0.10 && $bog4marcount<=0.20){
                    echo "<style>#bog4{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog5mar" class="bog5a">
            <button class="box" id="bog5"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-05 Problem in HH/MM: {{ $bog5marcount }}</span>
                ...
                if ($bog5marcount>=0.10 && $bog5marcount<=0.20){
                    echo "<style>#bog5{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog6mar" class="bog6a">
            <button class="box" id="bog6"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-06 Problem in HH/MM: {{ $bog6marcount }}</span>
                ...
                if ($bog6marcount>=0.10 && $bog6marcount<=0.20){
                    echo "<style>#bog6{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog7mar" class="bog7a">
            <button class="box" id="bog7"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-07 Problem in HH/MM: {{ $bog7marcount }}</span>
                ...
                if ($bog7marcount>=0.10 && $bog7marcount<=0.20){
                    echo "<style>#bog7{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog8mar" class="bog8a">
            <button class="box" id="bog8"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-08 Problem in HH/MM: {{ $bog8marcount }}</span>
                ...
                if ($bog8marcount>=0.10 && $bog8marcount<=0.20){
                    echo "<style>#bog8{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog9mar" class="bog9a">
            <button class="box" id="bog9"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-09 Problem in HH/MM: {{ $bog9marcount }}</span>
                ...
                if ($bog9marcount>=0.10 && $bog9marcount<=0.20){
                    echo "<style>#bog9{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog10mar" class="bog10a">
            <button class="box" id="bog10"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-10 Problem in HH/MM: {{ $bog10marcount }}</span>
                ...
                if ($bog10marcount>=0.10 && $bog10marcount<=0.20){
                    echo "<style>#bog10{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog11mar" class="bog11a">
            <button class="box" id="bog11"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-11 Problem in HH/MM: {{ $bog11marcount }}</span>
                ...
                if ($bog11marcount>=0.10 && $bog11marcount<=0.20){
                    echo "<style>#bog11{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog12mar" class="bog12a">
            <button class="box" id="bog12"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-12 Problem in HH/MM: {{ $bog12marcount }}</span>
                ...
                if ($bog12marcount>=0.10 && $bog12marcount<=0.20){
                    echo "<style>#bog12{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog13mar" class="bog13a">
            <button class="box" id="bog13"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-13 Problem in HH/MM: {{ $bog13marcount }}</span>
                ...
                if ($bog13marcount>=0.10 && $bog13marcount<=0.20){
                    echo "<style>#bog13{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog14mar" class="bog14a">
            <button class="box" id="bog14"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-14 Problem in HH/MM: {{ $bog14marcount }}</span>
                ...
                if ($bog14marcount>=0.10 && $bog14marcount<=0.20){
                    echo "<style>#bog14{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog15mar" class="bog15a">
            <button class="box" id="bog15"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-15 Problem in HH/MM: {{ $bog15marcount }}</span>
                ...
                if ($bog15marcount>=0.10 && $bog15marcount<=0.20){
                    echo "<style>#bog15{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog16mar" class="bog16a">
                <button class="box" id="bog16"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-16 Problem in HH/MM: {{ $bog16marcount }}</span>
                ...
                if ($bog16marcount>=0.10 && $bog16marcount<=0.20){
                    echo "<style>#bog16{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog17mar" class="bog17a">
            <button class="box" id="bog17"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-17 Problem in HH/MM: {{ $bog17marcount }}</span>
                ...
                if ($bog17marcount>=0.10 && $bog17marcount<=0.20){
                    echo "<style>#bog17{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog18mar" class="bog18a">
            <button class="box" id="bog18"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-18 Problem in HH/MM: {{ $bog18marcount }}</span>
                ...
                if ($bog18marcount>=0.10 && $bog18marcount<=0.20){
                    echo "<style>#bog18{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog19mar" class="bog19a">
            <button class="box" id="bog19"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-19 Problem in HH/MM: {{ $bog19marcount }}</span>
                ...
                if ($bog19marcount>=0.10 && $bog19marcount<=0.20){
                    echo "<style>#bog19{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog20mar" class="bog20a">
            <button class="box" id="bog20"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-20 Problem in HH/MM: {{ $bog20marcount }}</span>
                ...
                if ($bog20marcount>=0.10 && $bog20marcount<=0.20){
                    echo "<style>#bog20{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog21mar" class="bog21a">
            <button class="box" id="bog21"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-21 Problem in HH/MM: {{ $bog21marcount }}</span>
                ...
                if ($bog21marcount>=0.10 && $bog21marcount<=0.20){
                    echo "<style>#bog21{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog22mar" class="bog22a">
            <button class="box" id="bog22"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-22 Problem in HH/MM: {{ $bog22marcount }}</span>
                ...
                if ($bog22marcount>=0.10 && $bog22marcount<=0.20){
                    echo "<style>#bog22{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog23mar" class="bog23a">
            <button class="box" id="bog23"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-23 Problem in HH/MM: {{ $bog23marcount }}</span>
                ...
                if ($bog23marcount>=0.10 && $bog23marcount<=0.20){
                    echo "<style>#bog23{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog24mar" class="bog24a">
            <button class="box" id="bog24"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-24 Problem in HH/MM: {{ $bog24marcount }}</span>
                ...
                if ($bog24marcount>=0.10 && $bog24marcount<=0.20){
                    echo "<style>#bog24{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog25mar" class="bog25a">
            <button class="box" id="bog25"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-25 Problem in HH/MM: {{ $bog25marcount }}</span>
                ...
                if ($bog25marcount>=0.10 && $bog25marcount<=0.20){
                    echo "<style>#bog25{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog26mar" class="bog26a">
            <button class="box" id="bog26"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-26 Problem in HH/MM: {{ $bog26marcount }}</span>
                ...
                if ($bog26marcount>=0.10 && $bog26marcount<=0.20){
                    echo "<style>#bog26{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog27mar" class="bog27a">
            <button class="box" id="bog27"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-27 Problem in HH/MM: {{ $bog27marcount }}</span>
                ...
                if ($bog27marcount>=0.10 && $bog27marcount<=0.20){
                    echo "<style>#bog27{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog28mar" class="bog28a">
            <button class="box" id="bog28"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-28 Problem in HH/MM: {{ $bog28marcount }}</span>
                ...
                if ($bog28marcount>=0.10 && $bog28marcount<=0.20){
                    echo "<style>#bog28{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog29mar" class="bog29a">
            <button class="box" id="bog29"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-29 Problem in HH/MM: {{ $bog29marcount }}</span>
                ...
                if ($bog29marcount>=0.10 && $bog29marcount<=0.20){
                    echo "<style>#bog29{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog30mar" class="bog30a">
            <button class="box" id="bog30"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-30 Problem in HH/MM: {{ $bog30marcount }}</span>
                ...
                if ($bog30marcount>=0.10 && $bog30marcount<=0.20){
                    echo "<style>#bog30{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog31mar" class="bog31a">
            <button class="box" id="bog31"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-31 Problem in HH/MM: {{ $bog31marcount }}</span>
                ...
                if ($bog31marcount>=0.10 && $bog31marcount<=0.20){
                    echo "<style>#bog31{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
