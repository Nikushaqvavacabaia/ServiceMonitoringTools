...
<body>
									...
									<td>  
										<?php
											...
											if($date2 < $date1){
												...
												array_push($silknetaugall, $date4);
												echo($date4);
												
											}
											else{
												array_push($silknetaugall, (float)$diff->format("%h.%i"));
	...
	<script type="text/javascript">
		...
		alertAudio.play();
		alert("All Problems of Silknet August --> " + {{$counter}} + "\nSum of time Silknet August Problems --> " + {{array_sum($silknetaugall)}} + " Hour")
