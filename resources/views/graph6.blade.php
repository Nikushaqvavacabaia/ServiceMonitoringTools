...
<br><br><br><br>
		...
		<section id="s-team" class="section">
			...
			<br><br><br>
            <?php 
            $sumofprov=($sumbogjun + $sumtbcjun + $sumoppajun + $sumipayjun + $sumtbcpayjun + $sumnovapaymentsjun + $sumegtjun + $sumeverymatrixjun + $sumoppajun + $sumbetconstructjun + $sumbetradarjun + $sumgoldenracejun + $sumevolutiongamingjun + $sumlambdajun + $sumigrosoftjun +  $sumsilknetjun + $summagtijun + $sumglobalcelljun + $sumcaucasusjun + $sumlivecallerjun);
            $sumofnetwork=$sumitsupportjun;
            $sumofback=$sumsbbettingjun;
            $sumoffront=$sumfrontjun;
