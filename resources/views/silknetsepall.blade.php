...
<body>
									...
									<td>  
										<?php
											...
											if($date2 < $date1){
												...
												array_push($silknetsepall, $date4);
												echo($date4);
												
											}
											else{
												array_push($silknetsepall, (float)$diff->format("%h.%i"));
	...
	<script type="text/javascript">
		...
		alertAudio.play();
		alert("All Problems of Silknet September --> " + {{$counter}} + "\nSum of time Silknet September Problems --> " + {{array_sum($silknetsepall)}} + " Hour")
