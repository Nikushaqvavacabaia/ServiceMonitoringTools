...
<br><br><br><br>
		...
		<section id="s-team" class="section">
			...
			<br><br><br>
            <?php 
            $sumofprov=($sumbogaug + $sumtbcaug + $sumoppaaug + $sumipayaug + $sumtbcpayaug + $sumnovapaymentsaug + $sumegtaug + $sumeverymatrixaug + $sumoppaaug + $sumbetconstructaug + $sumbetradaraug + $sumgoldenraceaug + $sumevolutiongamingaug + $sumlambdaaug + $sumigrosoftaug +  $sumsilknetaug + $summagtiaug + $sumglobalcellaug + $sumcaucasusaug + $sumlivecalleraug);
            $sumofnetwork=$sumitsupportaug;
            $sumofback=$sumsbbettingaug;
            $sumoffront=$sumfrontaug;
