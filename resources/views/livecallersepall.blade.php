...
<body>
	...
	<script type="text/javascript">
		...
		"/Music/livecaller.mp3"
		);
		<?php 

		$counter=count($monitorings); ?>
		alertAudio.play();
		alert("All Problems of livecaller September --> " + {{$counter}} + "\nSum of time livecaller September Problems --> " + {{array_sum($livecallersepall)}} + " Hour")
