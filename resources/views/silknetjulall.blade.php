...
<body>
									...
									<td>  
										<?php
											...
											if($date2 < $date1){
												...
												array_push($silknetjulall, $date4);
												echo($date4);
												
											}
											else{
												array_push($silknetjulall, (float)$diff->format("%h.%i"));
	...
	<script type="text/javascript">
		...
		alertAudio.play();
		alert("All Problems of Silknet July --> " + {{$counter}} + "\nSum of time Silknet July Problems --> " + {{array_sum($silknetjulall)}} + " Hour")
