...
<br><br><br><br>
		...
		<section id="s-team" class="section">
			...
			<br><br><br>
            <?php 
            $sumofprov=($sumbogjul + $sumtbcjul + $sumoppajul + $sumipayjul + $sumtbcpayjul + $sumnovapaymentsjul + $sumegtjul + $sumeverymatrixjul + $sumoppajul + $sumbetconstructjul + $sumbetradarjul + $sumgoldenracejul + $sumevolutiongamingjul + $sumlambdajul + $sumigrosoftjul +  $sumsilknetjul + $summagtijul + $sumglobalcelljul + $sumcaucasusjul + $sumlivecallerjul);
            $sumofnetwork=$sumitsupportjul;
            $sumofback=$sumsbbettingjul;
            $sumoffront=$sumfrontjul;
