...
<body>
									...
									<td>  
										<?php
											...
											if($date2 < $date1){
												...
												array_push($silknetfeball, $date4);
												echo($date4);
												
											}
											else{
												array_push($silknetfeball, (float)$diff->format("%h.%i"));
	...
	<script type="text/javascript">
		...
		alertAudio.play();
		alert("All Problems of Silknet February --> " + {{$counter}} + "\nSum of time Silknet February Problems --> " + {{array_sum($silknetfeball)}} + " Hour")
