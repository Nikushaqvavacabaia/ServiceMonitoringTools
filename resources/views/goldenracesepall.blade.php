...
<body>
	...
	<script type="text/javascript">
		...
		"/Music/goldenrace.mp3"
		);
		<?php 

		$counter=count($monitorings); ?>
		alertAudio.play();
		alert("All Problems of goldenrace September --> " + {{$counter}} + "\nSum of time goldenrace September Problems --> " + {{array_sum($goldenracesepall)}} + " Hour")
