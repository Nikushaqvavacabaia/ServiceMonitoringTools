...
<body>
    ...
    <div class="productBody">
        <div class="product1">
            <a class="provider_link" href="/tbcjanall">
                <h1 class="productHeader">UFC(TBC) - Issues in HH/MM: {{$sumtbcjan}}</h1>
            </a>
            <div class="graph">
            <a href="/tbc1jan" class="tbc1a">
            <button class="box" id="tbc1"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-01 Problem in HH/MM: {{ $tbc1jancount }}</span>
                ...
                if ($tbc1jancount>=0.10 && $tbc1jancount<=0.20){
                    echo "<style>#tbc1{
            ...
            <a href="/tbc2jan" class="tbc2a">
            <button class="box" id="tbc2"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-02 Problem in HH/MM: {{ $tbc2jancount }}</span>
                ...
                if ($tbc2jancount>=0.10 && $tbc2jancount<=0.20){
                    echo "<style>#tbc2{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc3jan" class="tbc3a">
            <button class="box" id="tbc3"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-03 Problem in HH/MM: {{ $tbc3jancount }}</span>
                ...
                if ($tbc3jancount>=0.10 && $tbc3jancount<=0.20){
                    echo "<style>#tbc3{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc4jan" class="tbc4a">
            <button class="box" id="tbc4"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-04 Problem in HH/MM: {{ $tbc4jancount }}</span>
                ...
                if ($tbc4jancount>=0.10 && $tbc4jancount<=0.20){
                    echo "<style>#tbc4{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc5jan" class="tbc5a">
            <button class="box" id="tbc5"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-05 Problem in HH/MM: {{ $tbc5jancount }}</span>
                ...
                if ($tbc5jancount>=0.10 && $tbc5jancount<=0.20){
                    echo "<style>#tbc5{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc6jan" class="tbc6a">
            <button class="box" id="tbc6"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-06 Problem in HH/MM: {{ $tbc6jancount }}</span>
                ...
                if ($tbc6jancount>=0.10 && $tbc6jancount<=0.20){
                    echo "<style>#tbc6{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc7jan" class="tbc7a">
            <button class="box" id="tbc7"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-07 Problem in HH/MM: {{ $tbc7jancount }}</span>
                ...
                if ($tbc7jancount>=0.10 && $tbc7jancount<=0.20){
                    echo "<style>#tbc7{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc8jan" class="tbc8a">
            <button class="box" id="tbc8"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-08 Problem in HH/MM: {{ $tbc8jancount }}</span>
                ...
                if ($tbc8jancount>=0.10 && $tbc8jancount<=0.20){
                    echo "<style>#tbc8{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc9jan" class="tbc9a">
            <button class="box" id="tbc9"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-09 Problem in HH/MM: {{ $tbc9jancount }}</span>
                ...
                if ($tbc9jancount>=0.10 && $tbc9jancount<=0.20){
                    echo "<style>#tbc9{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc10jan" class="tbc10a">
            <button class="box" id="tbc10"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-10 Problem in HH/MM: {{ $tbc10jancount }}</span>
                ...
                if ($tbc10jancount>=0.10 && $tbc10jancount<=0.20){
                    echo "<style>#tbc10{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc11jan" class="tbc11a">
            <button class="box" id="tbc11"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-11 Problem in HH/MM: {{ $tbc11jancount }}</span>
                ...
                if ($tbc11jancount>=0.10 && $tbc11jancount<=0.20){
                    echo "<style>#tbc11{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc12jan" class="tbc12a">
            <button class="box" id="tbc12"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-12 Problem in HH/MM: {{ $tbc12jancount }}</span>
                ...
                if ($tbc12jancount>=0.10 && $tbc12jancount<=0.20){
                    echo "<style>#tbc12{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc13jan" class="tbc13a">
            <button class="box" id="tbc13"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-13 Problem in HH/MM: {{ $tbc13jancount }}</span>
                ...
                if ($tbc13jancount>=0.10 && $tbc13jancount<=0.20){
                    echo "<style>#tbc13{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc14jan" class="tbc14a">
            <button class="box" id="tbc14"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-14 Problem in HH/MM: {{ $tbc14jancount }}</span>
                ...
                if ($tbc14jancount>=0.10 && $tbc14jancount<=0.20){
                    echo "<style>#tbc14{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc15jan" class="tbc15a">
            <button class="box" id="tbc15"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-15 Problem in HH/MM: {{ $tbc15jancount }}</span>
                ...
                if ($tbc15jancount>=0.10 && $tbc15jancount<=0.20){
                    echo "<style>#tbc15{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc16jan" class="tbc16a">
            <button class="box" id="tbc16"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-16 Problem in HH/MM: {{ $tbc16jancount }}</span>
                ...
                if ($tbc16jancount>=0.10 && $tbc16jancount<=0.20){
                    echo "<style>#tbc16{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc17jan" class="tbc17a">
            <button class="box" id="tbc17"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-17 Problem in HH/MM: {{ $tbc17jancount }}</span>
                ...
                if ($tbc17jancount>=0.10 && $tbc17jancount<=0.20){
                    echo "<style>#tbc17{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc18jan" class="tbc18a">
            <button class="box" id="tbc18"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-18 Problem in HH/MM: {{ $tbc18jancount }}</span>
                ...
                if ($tbc18jancount>=0.10 && $tbc18jancount<=0.20){
                    echo "<style>#tbc18{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc19jan" class="tbc19a">
            <button class="box" id="tbc19"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-19 Problem in HH/MM: {{ $tbc19jancount }}</span>
                ...
                if ($tbc19jancount>=0.10 && $tbc19jancount<=0.20){
                    echo "<style>#tbc19{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc20jan" class="tbc20a">
            <button class="box" id="tbc20"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-20 Problem in HH/MM: {{ $tbc20jancount }}</span>
                ...
                if ($tbc20jancount>=0.10 && $tbc20jancount<=0.20){
                    echo "<style>#tbc20{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc21jan" class="tbc21a">
            <button class="box" id="tbc21"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-21 Problem in HH/MM: {{ $tbc21jancount }}</span>
                ...
                if ($tbc21jancount>=0.10 && $tbc21jancount<=0.20){
                    echo "<style>#tbc21{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc22jan" class="tbc22a">
            <button class="box" id="tbc22"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-22 Problem in HH/MM: {{ $tbc22jancount }}</span>
                ...
                if ($tbc22jancount>=0.10 && $tbc22jancount<=0.20){
                    echo "<style>#tbc22{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc23jan" class="tbc23a">
            <button class="box" id="tbc23"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-23 Problem in HH/MM: {{ $tbc23jancount }}</span>
                ...
                if ($tbc23jancount>=0.10 && $tbc23jancount<=0.20){
                    echo "<style>#tbc23{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc24jan" class="tbc24a">
            <button class="box" id="tbc24"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-24 Problem in HH/MM: {{ $tbc24jancount }}</span>
                ...
                if ($tbc24jancount>=0.10 && $tbc24jancount<=0.20){
                    echo "<style>#tbc24{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc25jan" class="tbc25a">
            <button class="box" id="tbc25"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-25 Problem in HH/MM: {{ $tbc25jancount }}</span>
                ...
                if ($tbc25jancount>=0.10 && $tbc25jancount<=0.20){
                    echo "<style>#tbc25{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc26jan" class="tbc26a">
            <button class="box" id="tbc26"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-26 Problem in HH/MM: {{ $tbc26jancount }}</span>
                ...
                if ($tbc26jancount>=0.10 && $tbc26jancount<=0.20){
                    echo "<style>#tbc26{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc27jan" class="tbc27a">
            <button class="box" id="tbc27"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-27 Problem in HH/MM: {{ $tbc27jancount }}</span>
                ...
                if ($tbc27jancount>=0.10 && $tbc27jancount<=0.20){
                    echo "<style>#tbc27{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc28jan" class="tbc28a">
            <button class="box" id="tbc28"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-28 Problem in HH/MM: {{ $tbc28jancount }}</span>
                ...
                if ($tbc28jancount>=0.10 && $tbc28jancount<=0.20){
                    echo "<style>#tbc28{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc29jan" class="tbc29a">
            <button class="box" id="tbc29"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-29 Problem in HH/MM: {{ $tbc29jancount }}</span>
                ...
                if ($tbc29jancount>=0.10 && $tbc29jancount<=0.20){
                    echo "<style>#tbc29{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc30jan" class="tbc30a">
            <button class="box" id="tbc30"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-30 Problem in HH/MM: {{ $tbc30jancount }}</span>
                ...
                if ($tbc30jancount>=0.10 && $tbc30jancount<=0.20){
                    echo "<style>#tbc30{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
			...
			<a href="/tbc31jan" class="tbc31a">
            <button class="box" id="tbc31"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-31 Problem in HH/MM: {{ $tbc31jancount }}</span>
                ...
                if ($tbc31jancount>=0.10 && $tbc31jancount<=0.20){
                    echo "<style>#tbc31{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
