...
<body>
	...
	<script type="text/javascript">
		...
		"/Music/globalcell.mp3"
		);
		<?php 

		$counter=count($monitorings); ?>
		alertAudio.play();
		alert("All Problems of globalcell September --> " + {{$counter}} + "\nSum of time globalcell September Problems --> " + {{array_sum($globalcellsepall)}} + " Hour")
