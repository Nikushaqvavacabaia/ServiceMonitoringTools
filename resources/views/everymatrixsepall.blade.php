...
<body>
	...
	<script type="text/javascript">
		...
		"/Music/everymatrix.mp3"
		);
		<?php 

		$counter=count($monitorings); ?>
		alertAudio.play();
		alert("All Problems of everymatrix September --> " + {{$counter}} + "\nSum of time everymatrix September Problems --> " + {{array_sum($everymatrixsepall)}} + " Hour")
