...
<body>
    ...
    <div class="productBody">
        <div class="product1">
            <a class="provider_link" href="/bogjulall">
                <h1 class="product1Header">GC (BOG) - Issues in HH/MM: {{$sumbogjul}}</h1>
            </a>

            <div class="graph">
            <a href="/bog1jul" class="bog1a">
            <button class="box" id="bog1"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext"> {{$lst}}-01 Problem in HH/MM: {{ $bog1julcount }}</span>
                ...
                if ($bog1julcount>=0.10 && $bog1julcount<=0.20){
                    echo "<style>#bog1{
            ...
            <a href="/bog2jul" class="bog2a">
            <button class="box" id="bog2"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-02 Problem in HH/MM: {{ $bog2julcount }}</span>
                ...
                if ($bog2julcount >=0.10 && $bog2julcount<=0.20){
                    echo "<style>#bog2{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog3jul" class="bog3a">
            <button class="box" id="bog3"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-03 Problem in HH/MM: {{ $bog3julcount }}</span>
                ...
                if ($bog3julcount>=0.10 && $bog3julcount<=0.20){
                    echo "<style>#bog3{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog4jul" class="bog4a">
            <button class="box" id="bog4"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-04 Problem in HH/MM: {{ $bog4julcount }}</span>
                ...
                if ($bog4julcount>=0.10 && $bog4julcount<=0.20){
                    echo "<style>#bog4{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog5jul" class="bog5a">
            <button class="box" id="bog5"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-05 Problem in HH/MM: {{ $bog5julcount }}</span>
                ...
                if ($bog5julcount>=0.10 && $bog5julcount<=0.20){
                    echo "<style>#bog5{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog6jul" class="bog6a">
            <button class="box" id="bog6"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-06 Problem in HH/MM: {{ $bog6julcount }}</span>
                ...
                if ($bog6julcount>=0.10 && $bog6julcount<=0.20){
                    echo "<style>#bog6{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog7jul" class="bog7a">
            <button class="box" id="bog7"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-07 Problem in HH/MM: {{ $bog7julcount }}</span>
                ...
                if ($bog7julcount>=0.10 && $bog7julcount<=0.20){
                    echo "<style>#bog7{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog8jul" class="bog8a">
            <button class="box" id="bog8"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-08 Problem in HH/MM: {{ $bog8julcount }}</span>
                ...
                if ($bog8julcount>=0.10 && $bog8julcount<=0.20){
                    echo "<style>#bog8{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog9jul" class="bog9a">
            <button class="box" id="bog9"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-09 Problem in HH/MM: {{ $bog9julcount }}</span>
                ...
                if ($bog9julcount>=0.10 && $bog9julcount<=0.20){
                    echo "<style>#bog9{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog10jul" class="bog10a">
            <button class="box" id="bog10"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-10 Problem in HH/MM: {{ $bog10julcount }}</span>
                ...
                if ($bog10julcount>=0.10 && $bog10julcount<=0.20){
                    echo "<style>#bog10{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog11jul" class="bog11a">
            <button class="box" id="bog11"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-11 Problem in HH/MM: {{ $bog11julcount }}</span>
                ...
                if ($bog11julcount>=0.10 && $bog11julcount<=0.20){
                    echo "<style>#bog11{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog12jul" class="bog12a">
            <button class="box" id="bog12"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-12 Problem in HH/MM: {{ $bog12julcount }}</span>
                ...
                if ($bog12julcount>=0.10 && $bog12julcount<=0.20){
                    echo "<style>#bog12{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog13jul" class="bog13a">
            <button class="box" id="bog13"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-13 Problem in HH/MM: {{ $bog13julcount }}</span>
                ...
                if ($bog13julcount>=0.10 && $bog13julcount<=0.20){
                    echo "<style>#bog13{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog14jul" class="bog14a">
            <button class="box" id="bog14"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-14 Problem in HH/MM: {{ $bog14julcount }}</span>
                ...
                if ($bog14julcount>=0.10 && $bog14julcount<=0.20){
                    echo "<style>#bog14{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog15jul" class="bog15a">
            <button class="box" id="bog15"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-15 Problem in HH/MM: {{ $bog15julcount }}</span>
                ...
                if ($bog15julcount>=0.10 && $bog15julcount<=0.20){
                    echo "<style>#bog15{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog16jul" class="bog16a">
                <button class="box" id="bog16"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-16 Problem in HH/MM: {{ $bog16julcount }}</span>
                ...
                if ($bog16julcount>=0.10 && $bog16julcount<=0.20){
                    echo "<style>#bog16{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog17jul" class="bog17a">
            <button class="box" id="bog17"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-17 Problem in HH/MM: {{ $bog17julcount }}</span>
                ...
                if ($bog17julcount>=0.10 && $bog17julcount<=0.20){
                    echo "<style>#bog17{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog18jul" class="bog18a">
            <button class="box" id="bog18"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-18 Problem in HH/MM: {{ $bog18julcount }}</span>
                ...
                if ($bog18julcount>=0.10 && $bog18julcount<=0.20){
                    echo "<style>#bog18{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog19jul" class="bog19a">
            <button class="box" id="bog19"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-19 Problem in HH/MM: {{ $bog19julcount }}</span>
                ...
                if ($bog19julcount>=0.10 && $bog19julcount<=0.20){
                    echo "<style>#bog19{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog20jul" class="bog20a">
            <button class="box" id="bog20"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-20 Problem in HH/MM: {{ $bog20julcount }}</span>
                ...
                if ($bog20julcount>=0.10 && $bog20julcount<=0.20){
                    echo "<style>#bog20{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog21jul" class="bog21a">
            <button class="box" id="bog21"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-21 Problem in HH/MM: {{ $bog21julcount }}</span>
                ...
                if ($bog21julcount>=0.10 && $bog21julcount<=0.20){
                    echo "<style>#bog21{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog22jul" class="bog22a">
            <button class="box" id="bog22"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-22 Problem in HH/MM: {{ $bog22julcount }}</span>
                ...
                if ($bog22julcount>=0.10 && $bog22julcount<=0.20){
                    echo "<style>#bog22{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog23jul" class="bog23a">
            <button class="box" id="bog23"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-23 Problem in HH/MM: {{ $bog23julcount }}</span>
                ...
                if ($bog23julcount>=0.10 && $bog23julcount<=0.20){
                    echo "<style>#bog23{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog24jul" class="bog24a">
            <button class="box" id="bog24"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-24 Problem in HH/MM: {{ $bog24julcount }}</span>
                ...
                if ($bog24julcount>=0.10 && $bog24julcount<=0.20){
                    echo "<style>#bog24{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog25jul" class="bog25a">
            <button class="box" id="bog25"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-25 Problem in HH/MM: {{ $bog25julcount }}</span>
                ...
                if ($bog25julcount>=0.10 && $bog25julcount<=0.20){
                    echo "<style>#bog25{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog26jul" class="bog26a">
            <button class="box" id="bog26"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-26 Problem in HH/MM: {{ $bog26julcount }}</span>
                ...
                if ($bog26julcount>=0.10 && $bog26julcount<=0.20){
                    echo "<style>#bog26{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog27jul" class="bog27a">
            <button class="box" id="bog27"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-27 Problem in HH/MM: {{ $bog27julcount }}</span>
                ...
                if ($bog27julcount>=0.10 && $bog27julcount<=0.20){
                    echo "<style>#bog27{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog28jul" class="bog28a">
            <button class="box" id="bog28"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-28 Problem in HH/MM: {{ $bog28julcount }}</span>
                ...
                if ($bog28julcount>=0.10 && $bog28julcount<=0.20){
                    echo "<style>#bog28{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog29jul" class="bog29a">
            <button class="box" id="bog29"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-29 Problem in HH/MM: {{ $bog29julcount }}</span>
                ...
                if ($bog29julcount>=0.10 && $bog29julcount<=0.20){
                    echo "<style>#bog29{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog30jul" class="bog30a">
            <button class="box" id="bog30"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-30 Problem in HH/MM: {{ $bog30julcount }}</span>
                ...
                if ($bog30julcount>=0.10 && $bog30julcount<=0.20){
                    echo "<style>#bog30{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog31jul" class="bog31a">
            <button class="box" id="bog31"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-31 Problem in HH/MM: {{ $bog31julcount }}</span>
                ...
                if ($bog31julcount>=0.10 && $bog31julcount<=0.20){
                    echo "<style>#bog31{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
