...
<body>
									...
									<td>  
										<?php
											...
											if($date2 < $date1){
												...
												array_push($silknetjunall, $date4);
												echo($date4);
												
											}
											else{
												array_push($silknetjunall, (float)$diff->format("%h.%i"));
	...
	<script type="text/javascript">
		...
		alertAudio.play();
		alert("All Problems of Silknet Jun --> " + {{$counter}} + "\nSum of time Silknet Jun Problems --> " + {{array_sum($silknetjunall)}} + " Hour")
