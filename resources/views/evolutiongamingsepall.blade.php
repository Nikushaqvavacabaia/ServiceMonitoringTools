...
<body>
	...
	<script type="text/javascript">
		...
		"/Music/evolutiongaming.mp3"
		);
		<?php 

		$counter=count($monitorings); ?>
		alertAudio.play();
		alert("All Problems of evolutiongaming September --> " + {{$counter}} + "\nSum of time evolutiongaming September Problems --> " + {{array_sum($evolutiongamingsepall)}} + " Hour")
