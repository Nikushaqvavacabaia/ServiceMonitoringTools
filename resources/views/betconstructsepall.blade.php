...
<body>
	...
	<script type="text/javascript">
		...
		"/Music/betconstruct.mp3"
		);
		<?php 

		$counter=count($monitorings); ?>
		alertAudio.play();
		alert("All Problems of betconstruct September --> " + {{$counter}} + "\nSum of time betconstruct September Problems --> " + {{array_sum($betconstructsepall)}} + " Hour")
