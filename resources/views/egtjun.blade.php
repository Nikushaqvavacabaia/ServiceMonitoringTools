...
<body>
    ...
    <div class="productBody">
        <div class="product1">
            <a class="provider_link" href="/egtjunall">
                <h1 class="product1Header">EGT - Issues in HH/MM: {{$sumegtjun}}</h1>
            </a>

            <div class="graph">
            <a href="/egt1jun" class="egt1a">
            <button class="box" id="egt1"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext"> {{$lst}}-01 Problem in HH/MM: {{ $egt1juncount }}</span>
                ...
                if ($egt1juncount>=0.10 && $egt1juncount<=0.20){
                    echo "<style>#egt1{
            ...
            <a href="/egt2jun" class="egt2a">
            <button class="box" id="egt2"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-02 Problem in HH/MM: {{ $egt2juncount }}</span>
                ...
                if ($egt2juncount >=0.10 && $egt2juncount<=0.20){
                    echo "<style>#egt2{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt3jun" class="egt3a">
            <button class="box" id="egt3"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-03 Problem in HH/MM: {{ $egt3juncount }}</span>
                ...
                if ($egt3juncount>=0.10 && $egt3juncount<=0.20){
                    echo "<style>#egt3{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt4jun" class="egt4a">
            <button class="box" id="egt4"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-04 Problem in HH/MM: {{ $egt4juncount }}</span>
                ...
                if ($egt4juncount>=0.10 && $egt4juncount<=0.20){
                    echo "<style>#egt4{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt5jun" class="egt5a">
            <button class="box" id="egt5"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-05 Problem in HH/MM: {{ $egt5juncount }}</span>
                ...
                if ($egt5juncount>=0.10 && $egt5juncount<=0.20){
                    echo "<style>#egt5{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt6jun" class="egt6a">
            <button class="box" id="egt6"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-06 Problem in HH/MM: {{ $egt6juncount }}</span>
                ...
                if ($egt6juncount>=0.10 && $egt6juncount<=0.20){
                    echo "<style>#egt6{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt7jun" class="egt7a">
            <button class="box" id="egt7"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-07 Problem in HH/MM: {{ $egt7juncount }}</span>
                ...
                if ($egt7juncount>=0.10 && $egt7juncount<=0.20){
                    echo "<style>#egt7{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt8jun" class="egt8a">
            <button class="box" id="egt8"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-08 Problem in HH/MM: {{ $egt8juncount }}</span>
                ...
                if ($egt8juncount>=0.10 && $egt8juncount<=0.20){
                    echo "<style>#egt8{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt9jun" class="egt9a">
            <button class="box" id="egt9"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-09 Problem in HH/MM: {{ $egt9juncount }}</span>
                ...
                if ($egt9juncount>=0.10 && $egt9juncount<=0.20){
                    echo "<style>#egt9{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt10jun" class="egt10a">
            <button class="box" id="egt10"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-10 Problem in HH/MM: {{ $egt10juncount }}</span>
                ...
                if ($egt10juncount>=0.10 && $egt10juncount<=0.20){
                    echo "<style>#egt10{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt11jun" class="egt11a">
            <button class="box" id="egt11"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-11 Problem in HH/MM: {{ $egt11juncount }}</span>
                ...
                if ($egt11juncount>=0.10 && $egt11juncount<=0.20){
                    echo "<style>#egt11{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt12jun" class="egt12a">
            <button class="box" id="egt12"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-12 Problem in HH/MM: {{ $egt12juncount }}</span>
                ...
                if ($egt12juncount>=0.10 && $egt12juncount<=0.20){
                    echo "<style>#egt12{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt13jun" class="egt13a">
            <button class="box" id="egt13"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-13 Problem in HH/MM: {{ $egt13juncount }}</span>
                ...
                if ($egt13juncount>=0.10 && $egt13juncount<=0.20){
                    echo "<style>#egt13{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt14jun" class="egt14a">
            <button class="box" id="egt14"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-14 Problem in HH/MM: {{ $egt14juncount }}</span>
                ...
                if ($egt14juncount>=0.10 && $egt14juncount<=0.20){
                    echo "<style>#egt14{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt15jun" class="egt15a">
            <button class="box" id="egt15"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-15 Problem in HH/MM: {{ $egt15juncount }}</span>
                ...
                if ($egt15juncount>=0.10 && $egt15juncount<=0.20){
                    echo "<style>#egt15{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt16jun" class="egt16a">
                <button class="box" id="egt16"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-16 Problem in HH/MM: {{ $egt16juncount }}</span>
                ...
                if ($egt16juncount>=0.10 && $egt16juncount<=0.20){
                    echo "<style>#egt16{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt17jun" class="egt17a">
            <button class="box" id="egt17"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-17 Problem in HH/MM: {{ $egt17juncount }}</span>
                ...
                if ($egt17juncount>=0.10 && $egt17juncount<=0.20){
                    echo "<style>#egt17{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt18jun" class="egt18a">
            <button class="box" id="egt18"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-18 Problem in HH/MM: {{ $egt18juncount }}</span>
                ...
                if ($egt18juncount>=0.10 && $egt18juncount<=0.20){
                    echo "<style>#egt18{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt19jun" class="egt19a">
            <button class="box" id="egt19"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-19 Problem in HH/MM: {{ $egt19juncount }}</span>
                ...
                if ($egt19juncount>=0.10 && $egt19juncount<=0.20){
                    echo "<style>#egt19{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt20jun" class="egt20a">
            <button class="box" id="egt20"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-20 Problem in HH/MM: {{ $egt20juncount }}</span>
                ...
                if ($egt20juncount>=0.10 && $egt20juncount<=0.20){
                    echo "<style>#egt20{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt21jun" class="egt21a">
            <button class="box" id="egt21"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-21 Problem in HH/MM: {{ $egt21juncount }}</span>
                ...
                if ($egt21juncount>=0.10 && $egt21juncount<=0.20){
                    echo "<style>#egt21{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt22jun" class="egt22a">
            <button class="box" id="egt22"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-22 Problem in HH/MM: {{ $egt22juncount }}</span>
                ...
                if ($egt22juncount>=0.10 && $egt22juncount<=0.20){
                    echo "<style>#egt22{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt23jun" class="egt23a">
            <button class="box" id="egt23"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-23 Problem in HH/MM: {{ $egt23juncount }}</span>
                ...
                if ($egt23juncount>=0.10 && $egt23juncount<=0.20){
                    echo "<style>#egt23{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt24jun" class="egt24a">
            <button class="box" id="egt24"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-24 Problem in HH/MM: {{ $egt24juncount }}</span>
                ...
                if ($egt24juncount>=0.10 && $egt24juncount<=0.20){
                    echo "<style>#egt24{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt25jun" class="egt25a">
            <button class="box" id="egt25"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-25 Problem in HH/MM: {{ $egt25juncount }}</span>
                ...
                if ($egt25juncount>=0.10 && $egt25juncount<=0.20){
                    echo "<style>#egt25{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt26jun" class="egt26a">
            <button class="box" id="egt26"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-26 Problem in HH/MM: {{ $egt26juncount }}</span>
                ...
                if ($egt26juncount>=0.10 && $egt26juncount<=0.20){
                    echo "<style>#egt26{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt27jun" class="egt27a">
            <button class="box" id="egt27"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-27 Problem in HH/MM: {{ $egt27juncount }}</span>
                ...
                if ($egt27juncount>=0.10 && $egt27juncount<=0.20){
                    echo "<style>#egt27{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt28jun" class="egt28a">
            <button class="box" id="egt28"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-28 Problem in HH/MM: {{ $egt28juncount }}</span>
                ...
                if ($egt28juncount>=0.10 && $egt28juncount<=0.20){
                    echo "<style>#egt28{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt29jun" class="egt29a">
            <button class="box" id="egt29"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-29 Problem in HH/MM: {{ $egt29juncount }}</span>
                ...
                if ($egt29juncount>=0.10 && $egt29juncount<=0.20){
                    echo "<style>#egt29{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt30jun" class="egt30a">
            <button class="box" id="egt30"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-30 Problem in HH/MM: {{ $egt30juncount }}</span>
                ...
                if ($egt30juncount>=0.10 && $egt30juncount<=0.20){
                    echo "<style>#egt30{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt31jun" class="egt31a">
            <button class="box" id="egt31"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-31 Problem in HH/MM: {{ $egt31juncount }}</span>
                ...
                if ($egt31juncount>=0.10 && $egt31juncount<=0.20){
                    echo "<style>#egt31{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
