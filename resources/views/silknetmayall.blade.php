...
<body>
									...
									<td>  
										<?php
											...
											if($date2 < $date1){
												...
												array_push($silknetmayall, $date4);
												echo($date4);
												
											}
											else{
												array_push($silknetmayall, (float)$diff->format("%h.%i"));
	...
	<script type="text/javascript">
		...
		alertAudio.play();
		alert("All Problems of Silknet May --> " + {{$counter}} + "\nSum of time Silknet May Problems --> " + {{array_sum($silknetmayall)}} + " Hour")
