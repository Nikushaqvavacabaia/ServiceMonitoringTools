...
<body>
    ...
    <div class="productBody">
        <div class="product1">
            <a class="provider_link" href="/tbcmayall">
                <h1 class="productHeader">UFC(TBC) - Issues in HH/MM: {{$sumtbcmay}}</h1>
            </a>
            <div class="graph">
            <a href="/tbc1may" class="tbc1a">
            <button class="box" id="tbc1"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-01 Problem in HH/MM: {{ $tbc1maycount }}</span>
                ...
                if ($tbc1maycount>=0.10 && $tbc1maycount<=0.20){
                    echo "<style>#tbc1{
            ...
            <a href="/tbc2may" class="tbc2a">
            <button class="box" id="tbc2"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-02 Problem in HH/MM: {{ $tbc2maycount }}</span>
                ...
                if ($tbc2maycount>=0.10 && $tbc2maycount<=0.20){
                    echo "<style>#tbc2{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc3may" class="tbc3a">
            <button class="box" id="tbc3"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-03 Problem in HH/MM: {{ $tbc3maycount }}</span>
                ...
                if ($tbc3maycount>=0.10 && $tbc3maycount<=0.20){
                    echo "<style>#tbc3{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc4may" class="tbc4a">
            <button class="box" id="tbc4"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-04 Problem in HH/MM: {{ $tbc4maycount }}</span>
                ...
                if ($tbc4maycount>=0.10 && $tbc4maycount<=0.20){
                    echo "<style>#tbc4{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc5may" class="tbc5a">
            <button class="box" id="tbc5"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-05 Problem in HH/MM: {{ $tbc5maycount }}</span>
                ...
                if ($tbc5maycount>=0.10 && $tbc5maycount<=0.20){
                    echo "<style>#tbc5{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc6may" class="tbc6a">
            <button class="box" id="tbc6"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-06 Problem in HH/MM: {{ $tbc6maycount }}</span>
                ...
                if ($tbc6maycount>=0.10 && $tbc6maycount<=0.20){
                    echo "<style>#tbc6{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc7may" class="tbc7a">
            <button class="box" id="tbc7"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-07 Problem in HH/MM: {{ $tbc7maycount }}</span>
                ...
                if ($tbc7maycount>=0.10 && $tbc7maycount<=0.20){
                    echo "<style>#tbc7{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc8may" class="tbc8a">
            <button class="box" id="tbc8"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-08 Problem in HH/MM: {{ $tbc8maycount }}</span>
                ...
                if ($tbc8maycount>=0.10 && $tbc8maycount<=0.20){
                    echo "<style>#tbc8{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc9may" class="tbc9a">
            <button class="box" id="tbc9"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-09 Problem in HH/MM: {{ $tbc9maycount }}</span>
                ...
                if ($tbc9maycount>=0.10 && $tbc9maycount<=0.20){
                    echo "<style>#tbc9{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc10may" class="tbc10a">
            <button class="box" id="tbc10"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-10 Problem in HH/MM: {{ $tbc10maycount }}</span>
                <?php if ("$lst-10"==date("Y-M-d")){
                    echo "<style>#tbc10{
                                    ...
                                    margin-left:2px;
                                    border: none;
                                    border-radiu               background-color: #6bad4c;
                        height: 100%;
                        width: 20px;
                        margin-left:2px;
                        border: none;
                ...
                if ($tbc10maycount>=0.10 && $tbc10maycount<=0.20){
                    echo "<style>#tbc10{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc11may" class="tbc11a">
            <button class="box" id="tbc11"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-11 Problem in HH/MM: {{ $tbc11maycount }}</span>
                ...
                if ($tbc11maycount>=0.10 && $tbc11maycount<=0.20){
                    echo "<style>#tbc11{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc12may" class="tbc12a">
            <button class="box" id="tbc12"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-12 Problem in HH/MM: {{ $tbc12maycount }}</span>
                ...
                if ($tbc12maycount>=0.10 && $tbc12maycount<=0.20){
                    echo "<style>#tbc12{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc13may" class="tbc13a">
            <button class="box" id="tbc13"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-13 Problem in HH/MM: {{ $tbc13maycount }}</span>
                ...
                if ($tbc13maycount>=0.10 && $tbc13maycount<=0.20){
                    echo "<style>#tbc13{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc14may" class="tbc14a">
            <button class="box" id="tbc14"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-14 Problem in HH/MM: {{ $tbc14maycount }}</span>
                ...
                if ($tbc14maycount>=0.10 && $tbc14maycount<=0.20){
                    echo "<style>#tbc14{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc15may" class="tbc15a">
            <button class="box" id="tbc15"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-15 Problem in HH/MM: {{ $tbc15maycount }}</span>
                ...
                if ($tbc15maycount>=0.10 && $tbc15maycount<=0.20){
                    echo "<style>#tbc15{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc16may" class="tbc16a">
            <button class="box" id="tbc16"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-16 Problem in HH/MM: {{ $tbc16maycount }}</span>
                ...
                if ($tbc16maycount>=0.10 && $tbc16maycount<=0.20){
                    echo "<style>#tbc16{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc17may" class="tbc17a">
            <button class="box" id="tbc17"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-17 Problem in HH/MM: {{ $tbc17maycount }}</span>
                ...
                if ($tbc17maycount>=0.10 && $tbc17maycount<=0.20){
                    echo "<style>#tbc17{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc18may" class="tbc18a">
            <button class="box" id="tbc18"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-18 Problem in HH/MM: {{ $tbc18maycount }}</span>
                ...
                if ($tbc18maycount>=0.10 && $tbc18maycount<=0.20){
                    echo "<style>#tbc18{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc19may" class="tbc19a">
            <button class="box" id="tbc19"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-19 Problem in HH/MM: {{ $tbc19maycount }}</span>
                ...
                if ($tbc19maycount>=0.10 && $tbc19maycount<=0.20){
                    echo "<style>#tbc19{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc20may" class="tbc20a">
            <button class="box" id="tbc20"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-20 Problem in HH/MM: {{ $tbc20maycount }}</span>
                ...
                if ($tbc20maycount>=0.10 && $tbc20maycount<=0.20){
                    echo "<style>#tbc20{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc21may" class="tbc21a">
            <button class="box" id="tbc21"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-21 Problem in HH/MM: {{ $tbc21maycount }}</span>
                ...
                if ($tbc21maycount>=0.10 && $tbc21maycount<=0.20){
                    echo "<style>#tbc21{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc22may" class="tbc22a">
            <button class="box" id="tbc22"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-22 Problem in HH/MM: {{ $tbc22maycount }}</span>
                ...
                if ($tbc22maycount>=0.10 && $tbc22maycount<=0.20){
                    echo "<style>#tbc22{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc23may" class="tbc23a">
            <button class="box" id="tbc23"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-23 Problem in HH/MM: {{ $tbc23maycount }}</span>
                ...
                if ($tbc23maycount>=0.10 && $tbc23maycount<=0.20){
                    echo "<style>#tbc23{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc24may" class="tbc24a">
            <button class="box" id="tbc24"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-24 Problem in HH/MM: {{ $tbc24maycount }}</span>
                ...
                if ($tbc24maycount>=0.10 && $tbc24maycount<=0.20){
                    echo "<style>#tbc24{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc25may" class="tbc25a">
            <button class="box" id="tbc25"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-25 Problem in HH/MM: {{ $tbc25maycount }}</span>
                ...
                if ($tbc25maycount>=0.10 && $tbc25maycount<=0.20){
                    echo "<style>#tbc25{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc26may" class="tbc26a">
            <button class="box" id="tbc26"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-26 Problem in HH/MM: {{ $tbc26maycount }}</span>
                ...
                if ($tbc26maycount>=0.10 && $tbc26maycount<=0.20){
                    echo "<style>#tbc26{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc27may" class="tbc27a">
            <button class="box" id="tbc27"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-27 Problem in HH/MM: {{ $tbc27maycount }}</span>
                ...
                if ($tbc27maycount>=0.10 && $tbc27maycount<=0.20){
                    echo "<style>#tbc27{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc28may" class="tbc28a">
            <button class="box" id="tbc28"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-28 Problem in HH/MM: {{ $tbc28maycount }}</span>
                ...
                if ($tbc28maycount>=0.10 && $tbc28maycount<=0.20){
                    echo "<style>#tbc28{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc29may" class="tbc29a">
            <button class="box" id="tbc29"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-29 Problem in HH/MM: {{ $tbc29maycount }}</span>
                ...
                if ($tbc29maycount>=0.10 && $tbc29maycount<=0.20){
                    echo "<style>#tbc29{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/tbc30may" class="tbc30a">
            <button class="box" id="tbc30"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-30 Problem in HH/MM: {{ $tbc30maycount }}</span>
                ...
                if ($tbc30maycount>=0.10 && $tbc30maycount<=0.20){
                    echo "<style>#tbc30{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
			...
			<a href="/tbc31may" class="tbc31a">
            <button class="box" id="tbc31"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-31 Problem in HH/MM: {{ $tbc31maycount }}</span>
                ...
                if ($tbc31maycount>=0.10 && $tbc31maycount<=0.20){
                    echo "<style>#tbc31{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
