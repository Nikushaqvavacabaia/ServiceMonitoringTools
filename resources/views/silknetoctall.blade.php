...
<body>
									...
									<td>  
										<?php
											...
											if($date2 < $date1){
												...
												array_push($silknetoctall, $date4);
												echo($date4);
												
											}
											else{
												array_push($silknetoctall, (float)$diff->format("%h.%i"));
	...
	<script type="text/javascript">
		...
		alertAudio.play();
		alert("All Problems of Silknet October --> " + {{$counter}} + "\nSum of time Silknet October Problems --> " + {{array_sum($silknetoctall)}} + " Hour")
