...
<br><br><br><br>
		...
		<section id="s-team" class="section">
			...
			<br><br><br>
            <?php 
            $sumofprov=($sumbognow + $sumtbcnow + $sumoppanow + $sumipaynow + $sumtbcpaynow + $sumnovapaymentsnow + $sumegtnow + $sumeverymatrixnow + $sumoppanow + $sumbetconstructnow + $sumbetradarnow + $sumgoldenracenow + $sumevolutiongamingnow + $sumlambdanow + $sumigrosoftnow +  $sumsilknetnow + $summagtinow + $sumglobalcellnow + $sumcaucasusnow + $sumlivecallernow);
            $sumofnetwork=$sumitsupportnow;
            $sumofback=$sumsbbettingnow;
            $sumoffront=$sumfrontnow;
