...
<body>
    ...
    <div class="productBody">
        <div class="product1">
            <a class="provider_link" href="/bogfeball">
                <h1 class="product1Header">GC (BOG) - Issues in HH/MM: {{$sumbogfeb}}</h1>
            </a>

            <div class="graph">
            <a href="/bog1feb" class="bog1a">
            <button class="box" id="bog1"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext"> {{$lst}}-01 Problem in HH/MM: {{ $bog1febcount }}</span>
                ...
                if ($bog1febcount>=0.10 && $bog1febcount<=0.20){
                    echo "<style>#bog1{
            ...
            <a href="/bog2feb" class="bog2a">
            <button class="box" id="bog2"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-02 Problem in HH/MM: {{ $bog2febcount }}</span>
                ...
                if ($bog2febcount >=0.10 && $bog2febcount<=0.20){
                    echo "<style>#bog2{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog3feb" class="bog3a">
            <button class="box" id="bog3"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-03 Problem in HH/MM: {{ $bog3febcount }}</span>
                ...
                if ($bog3febcount>=0.10 && $bog3febcount<=0.20){
                    echo "<style>#bog3{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog4feb" class="bog4a">
            <button class="box" id="bog4"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-04 Problem in HH/MM: {{ $bog4febcount }}</span>
                ...
                if ($bog4febcount>=0.10 && $bog4febcount<=0.20){
                    echo "<style>#bog4{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog5feb" class="bog5a">
            <button class="box" id="bog5"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-05 Problem in HH/MM: {{ $bog5febcount }}</span>
                ...
                if ($bog5febcount>=0.10 && $bog5febcount<=0.20){
                    echo "<style>#bog5{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog6feb" class="bog6a">
            <button class="box" id="bog6"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-06 Problem in HH/MM: {{ $bog6febcount }}</span>
                ...
                if ($bog6febcount>=0.10 && $bog6febcount<=0.20){
                    echo "<style>#bog6{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog7feb" class="bog7a">
            <button class="box" id="bog7"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-07 Problem in HH/MM: {{ $bog7febcount }}</span>
                ...
                if ($bog7febcount>=0.10 && $bog7febcount<=0.20){
                    echo "<style>#bog7{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog8feb" class="bog8a">
            <button class="box" id="bog8"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-08 Problem in HH/MM: {{ $bog8febcount }}</span>
                ...
                if ($bog8febcount>=0.10 && $bog8febcount<=0.20){
                    echo "<style>#bog8{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog9feb" class="bog9a">
            <button class="box" id="bog9"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-09 Problem in HH/MM: {{ $bog9febcount }}</span>
                ...
                if ($bog9febcount>=0.10 && $bog9febcount<=0.20){
                    echo "<style>#bog9{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog10feb" class="bog10a">
            <button class="box" id="bog10"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-10 Problem in HH/MM: {{ $bog10febcount }}</span>
                ...
                if ($bog10febcount>=0.10 && $bog10febcount<=0.20){
                    echo "<style>#bog10{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog11feb" class="bog11a">
            <button class="box" id="bog11"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-11 Problem in HH/MM: {{ $bog11febcount }}</span>
                ...
                if ($bog11febcount>=0.10 && $bog11febcount<=0.20){
                    echo "<style>#bog11{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog12feb" class="bog12a">
            <button class="box" id="bog12"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-12 Problem in HH/MM: {{ $bog12febcount }}</span>
                ...
                if ($bog12febcount>=0.10 && $bog12febcount<=0.20){
                    echo "<style>#bog12{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog13feb" class="bog13a">
            <button class="box" id="bog13"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-13 Problem in HH/MM: {{ $bog13febcount }}</span>
                ...
                if ($bog13febcount>=0.10 && $bog13febcount<=0.20){
                    echo "<style>#bog13{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog14feb" class="bog14a">
            <button class="box" id="bog14"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-14 Problem in HH/MM: {{ $bog14febcount }}</span>
                ...
                if ($bog14febcount>=0.10 && $bog14febcount<=0.20){
                    echo "<style>#bog14{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog15feb" class="bog15a">
            <button class="box" id="bog15"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-15 Problem in HH/MM: {{ $bog15febcount }}</span>
                ...
                if ($bog15febcount>=0.10 && $bog15febcount<=0.20){
                    echo "<style>#bog15{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog16feb" class="bog16a">
                <button class="box" id="bog16"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-16 Problem in HH/MM: {{ $bog16febcount }}</span>
                ...
                if ($bog16febcount>=0.10 && $bog16febcount<=0.20){
                    echo "<style>#bog16{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog17feb" class="bog17a">
            <button class="box" id="bog17"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-17 Problem in HH/MM: {{ $bog17febcount }}</span>
                ...
                if ($bog17febcount>=0.10 && $bog17febcount<=0.20){
                    echo "<style>#bog17{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog18feb" class="bog18a">
            <button class="box" id="bog18"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-18 Problem in HH/MM: {{ $bog18febcount }}</span>
                ...
                if ($bog18febcount>=0.10 && $bog18febcount<=0.20){
                    echo "<style>#bog18{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog19feb" class="bog19a">
            <button class="box" id="bog19"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-19 Problem in HH/MM: {{ $bog19febcount }}</span>
                ...
                if ($bog19febcount>=0.10 && $bog19febcount<=0.20){
                    echo "<style>#bog19{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog20feb" class="bog20a">
            <button class="box" id="bog20"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-20 Problem in HH/MM: {{ $bog20febcount }}</span>
                ...
                if ($bog20febcount>=0.10 && $bog20febcount<=0.20){
                    echo "<style>#bog20{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog21feb" class="bog21a">
            <button class="box" id="bog21"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-21 Problem in HH/MM: {{ $bog21febcount }}</span>
                ...
                if ($bog21febcount>=0.10 && $bog21febcount<=0.20){
                    echo "<style>#bog21{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog22feb" class="bog22a">
            <button class="box" id="bog22"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-22 Problem in HH/MM: {{ $bog22febcount }}</span>
                ...
                if ($bog22febcount>=0.10 && $bog22febcount<=0.20){
                    echo "<style>#bog22{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog23feb" class="bog23a">
            <button class="box" id="bog23"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-23 Problem in HH/MM: {{ $bog23febcount }}</span>
                ...
                if ($bog23febcount>=0.10 && $bog23febcount<=0.20){
                    echo "<style>#bog23{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog24feb" class="bog24a">
            <button class="box" id="bog24"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-24 Problem in HH/MM: {{ $bog24febcount }}</span>
                ...
                if ($bog24febcount>=0.10 && $bog24febcount<=0.20){
                    echo "<style>#bog24{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog25feb" class="bog25a">
            <button class="box" id="bog25"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-25 Problem in HH/MM: {{ $bog25febcount }}</span>
                ...
                if ($bog25febcount>=0.10 && $bog25febcount<=0.20){
                    echo "<style>#bog25{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog26feb" class="bog26a">
            <button class="box" id="bog26"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-26 Problem in HH/MM: {{ $bog26febcount }}</span>
                ...
                if ($bog26febcount>=0.10 && $bog26febcount<=0.20){
                    echo "<style>#bog26{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog27feb" class="bog27a">
            <button class="box" id="bog27"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-27 Problem in HH/MM: {{ $bog27febcount }}</span>
                ...
                if ($bog27febcount>=0.10 && $bog27febcount<=0.20){
                    echo "<style>#bog27{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog28feb" class="bog28a">
            <button class="box" id="bog28"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-28 Problem in HH/MM: {{ $bog28febcount }}</span>
                ...
                if ($bog28febcount>=0.10 && $bog28febcount<=0.20){
                    echo "<style>#bog28{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog29feb" class="bog29a">
            <button class="box" id="bog29"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-29 Problem in HH/MM: {{ $bog29febcount }}</span>
                ...
                if ($bog29febcount>=0.10 && $bog29febcount<=0.20){
                    echo "<style>#bog29{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog30feb" class="bog30a">
            <button class="box" id="bog30"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-30 Problem in HH/MM: {{ $bog30febcount }}</span>
                ...
                if ($bog30febcount>=0.10 && $bog30febcount<=0.20){
                    echo "<style>#bog30{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/bog31feb" class="bog31a">
            <button class="box" id="bog31"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-31 Problem in HH/MM: {{ $bog31febcount }}</span>
                ...
                if ($bog31febcount>=0.10 && $bog31febcount<=0.20){
                    echo "<style>#bog31{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
