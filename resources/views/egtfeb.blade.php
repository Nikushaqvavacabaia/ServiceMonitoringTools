...
<body>
    ...
    <div class="productBody">
        <div class="product1">
            <a class="provider_link" href="/egtfeball">
                <h1 class="product1Header">EGT - Issues in HH/MM: {{$sumegtfeb}}</h1>
            </a>

            <div class="graph">
            <a href="/egt1feb" class="egt1a">
            <button class="box" id="egt1"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext"> {{$lst}}-01 Problem in HH/MM: {{ $egt1febcount }}</span>
                ...
                if ($egt1febcount>=0.10 && $egt1febcount<=0.20){
                    echo "<style>#egt1{
            ...
            <a href="/egt2feb" class="egt2a">
            <button class="box" id="egt2"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-02 Problem in HH/MM: {{ $egt2febcount }}</span>
                ...
                if ($egt2febcount >=0.10 && $egt2febcount<=0.20){
                    echo "<style>#egt2{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt3feb" class="egt3a">
            <button class="box" id="egt3"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-03 Problem in HH/MM: {{ $egt3febcount }}</span>
                ...
                if ($egt3febcount>=0.10 && $egt3febcount<=0.20){
                    echo "<style>#egt3{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt4feb" class="egt4a">
            <button class="box" id="egt4"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-04 Problem in HH/MM: {{ $egt4febcount }}</span>
                ...
                if ($egt4febcount>=0.10 && $egt4febcount<=0.20){
                    echo "<style>#egt4{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt5feb" class="egt5a">
            <button class="box" id="egt5"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-05 Problem in HH/MM: {{ $egt5febcount }}</span>
                ...
                if ($egt5febcount>=0.10 && $egt5febcount<=0.20){
                    echo "<style>#egt5{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt6feb" class="egt6a">
            <button class="box" id="egt6"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-06 Problem in HH/MM: {{ $egt6febcount }}</span>
                ...
                if ($egt6febcount>=0.10 && $egt6febcount<=0.20){
                    echo "<style>#egt6{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt7feb" class="egt7a">
            <button class="box" id="egt7"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-07 Problem in HH/MM: {{ $egt7febcount }}</span>
                ...
                if ($egt7febcount>=0.10 && $egt7febcount<=0.20){
                    echo "<style>#egt7{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt8feb" class="egt8a">
            <button class="box" id="egt8"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-08 Problem in HH/MM: {{ $egt8febcount }}</span>
                ...
                if ($egt8febcount>=0.10 && $egt8febcount<=0.20){
                    echo "<style>#egt8{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt9feb" class="egt9a">
            <button class="box" id="egt9"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-09 Problem in HH/MM: {{ $egt9febcount }}</span>
                ...
                if ($egt9febcount>=0.10 && $egt9febcount<=0.20){
                    echo "<style>#egt9{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt10feb" class="egt10a">
            <button class="box" id="egt10"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-10 Problem in HH/MM: {{ $egt10febcount }}</span>
                ...
                if ($egt10febcount>=0.10 && $egt10febcount<=0.20){
                    echo "<style>#egt10{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt11feb" class="egt11a">
            <button class="box" id="egt11"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-11 Problem in HH/MM: {{ $egt11febcount }}</span>
                ...
                if ($egt11febcount>=0.10 && $egt11febcount<=0.20){
                    echo "<style>#egt11{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt12feb" class="egt12a">
            <button class="box" id="egt12"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-12 Problem in HH/MM: {{ $egt12febcount }}</span>
                ...
                if ($egt12febcount>=0.10 && $egt12febcount<=0.20){
                    echo "<style>#egt12{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt13feb" class="egt13a">
            <button class="box" id="egt13"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-13 Problem in HH/MM: {{ $egt13febcount }}</span>
                ...
                if ($egt13febcount>=0.10 && $egt13febcount<=0.20){
                    echo "<style>#egt13{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt14feb" class="egt14a">
            <button class="box" id="egt14"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-14 Problem in HH/MM: {{ $egt14febcount }}</span>
                ...
                if ($egt14febcount>=0.10 && $egt14febcount<=0.20){
                    echo "<style>#egt14{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt15feb" class="egt15a">
            <button class="box" id="egt15"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-15 Problem in HH/MM: {{ $egt15febcount }}</span>
                ...
                if ($egt15febcount>=0.10 && $egt15febcount<=0.20){
                    echo "<style>#egt15{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt16feb" class="egt16a">
                <button class="box" id="egt16"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-16 Problem in HH/MM: {{ $egt16febcount }}</span>
                ...
                if ($egt16febcount>=0.10 && $egt16febcount<=0.20){
                    echo "<style>#egt16{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt17feb" class="egt17a">
            <button class="box" id="egt17"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-17 Problem in HH/MM: {{ $egt17febcount }}</span>
                ...
                if ($egt17febcount>=0.10 && $egt17febcount<=0.20){
                    echo "<style>#egt17{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt18feb" class="egt18a">
            <button class="box" id="egt18"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-18 Problem in HH/MM: {{ $egt18febcount }}</span>
                ...
                if ($egt18febcount>=0.10 && $egt18febcount<=0.20){
                    echo "<style>#egt18{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt19feb" class="egt19a">
            <button class="box" id="egt19"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-19 Problem in HH/MM: {{ $egt19febcount }}</span>
                ...
                if ($egt19febcount>=0.10 && $egt19febcount<=0.20){
                    echo "<style>#egt19{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt20feb" class="egt20a">
            <button class="box" id="egt20"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-20 Problem in HH/MM: {{ $egt20febcount }}</span>
                ...
                if ($egt20febcount>=0.10 && $egt20febcount<=0.20){
                    echo "<style>#egt20{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt21feb" class="egt21a">
            <button class="box" id="egt21"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-21 Problem in HH/MM: {{ $egt21febcount }}</span>
                ...
                if ($egt21febcount>=0.10 && $egt21febcount<=0.20){
                    echo "<style>#egt21{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt22feb" class="egt22a">
            <button class="box" id="egt22"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-22 Problem in HH/MM: {{ $egt22febcount }}</span>
                ...
                if ($egt22febcount>=0.10 && $egt22febcount<=0.20){
                    echo "<style>#egt22{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt23feb" class="egt23a">
            <button class="box" id="egt23"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-23 Problem in HH/MM: {{ $egt23febcount }}</span>
                ...
                if ($egt23febcount>=0.10 && $egt23febcount<=0.20){
                    echo "<style>#egt23{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt24feb" class="egt24a">
            <button class="box" id="egt24"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-24 Problem in HH/MM: {{ $egt24febcount }}</span>
                ...
                if ($egt24febcount>=0.10 && $egt24febcount<=0.20){
                    echo "<style>#egt24{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt25feb" class="egt25a">
            <button class="box" id="egt25"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-25 Problem in HH/MM: {{ $egt25febcount }}</span>
                ...
                if ($egt25febcount>=0.10 && $egt25febcount<=0.20){
                    echo "<style>#egt25{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt26feb" class="egt26a">
            <button class="box" id="egt26"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-26 Problem in HH/MM: {{ $egt26febcount }}</span>
                ...
                if ($egt26febcount>=0.10 && $egt26febcount<=0.20){
                    echo "<style>#egt26{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt27feb" class="egt27a">
            <button class="box" id="egt27"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-27 Problem in HH/MM: {{ $egt27febcount }}</span>
                ...
                if ($egt27febcount>=0.10 && $egt27febcount<=0.20){
                    echo "<style>#egt27{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt28feb" class="egt28a">
            <button class="box" id="egt28"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-28 Problem in HH/MM: {{ $egt28febcount }}</span>
                ...
                if ($egt28febcount>=0.10 && $egt28febcount<=0.20){
                    echo "<style>#egt28{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt29feb" class="egt29a">
            <button class="box" id="egt29"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-29 Problem in HH/MM: {{ $egt29febcount }}</span>
                ...
                if ($egt29febcount>=0.10 && $egt29febcount<=0.20){
                    echo "<style>#egt29{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt30feb" class="egt30a">
            <button class="box" id="egt30"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-30 Problem in HH/MM: {{ $egt30febcount }}</span>
                ...
                if ($egt30febcount>=0.10 && $egt30febcount<=0.20){
                    echo "<style>#egt30{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
            ...
            <a href="/egt31feb" class="egt31a">
            <button class="box" id="egt31"  method="get">
                @foreach ($list as $lst)
                <span class="tooltiptext">{{$lst}}-31 Problem in HH/MM: {{ $egt31febcount }}</span>
                ...
                if ($egt31febcount>=0.10 && $egt31febcount<=0.20){
                    echo "<style>#egt31{
                                    background-color: #F7C631;
                                    height: 100%;
                                    width: 20px;
