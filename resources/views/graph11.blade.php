...
<br><br><br><br>
		...
		<section id="s-team" class="section">
			...
			<br><br><br>
            <?php 
            $sumofprov=($sumbognov + $sumtbcnov + $sumoppanov + $sumipaynov + $sumtbcpaynov + $sumnovapaymentsnov + $sumegtnov + $sumeverymatrixnov + $sumoppanov + $sumbetconstructnov + $sumbetradarnov + $sumgoldenracenov + $sumevolutiongamingnov + $sumlambdanov + $sumigrosoftnov +  $sumsilknetnov + $summagtinov + $sumglobalcellnov + $sumcaucasusnov + $sumlivecallernov);
            $sumofnetwork=$sumitsupportnov;
            $sumofback=$sumsbbettingnov;
            $sumoffront=$sumfrontnov;
