...
<br><br><br><br>
		...
		<section id="s-team" class="section">
			...
			<br><br><br>
            <?php 
            $sumofprov=($sumbogmar + $sumtbcmar + $sumoppamar + $sumipaymar + $sumtbcpaymar + $sumnovapaymentsmar + $sumegtmar + $sumeverymatrixmar + $sumoppamar + $sumbetconstructmar + $sumbetradarmar + $sumgoldenracemar + $sumevolutiongamingmar + $sumlambdamar + $sumigrosoftmar +  $sumsilknetmar + $summagtimar + $sumglobalcellmar + $sumcaucasusmar + $sumlivecallermar);
            $sumofnetwork=$sumitsupportmar;
            $sumofback=$sumsbbettingmar;
            $sumoffront=$sumfrontmar;
