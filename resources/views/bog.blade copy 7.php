...
<body>
									...
									<td>  
										<?php
											...
											if($date2 < $date1){
												...
												array_push($arrayoftime, $date4);
												echo($date4);
												
											}
											else{
												array_push($arrayoftime, (float)$diff->format("%h.%i"));
	...
	<script type="text/javascript">
		...
		alertAudio.play();
		alert("All Problems of BOG Current month --> " + {{$counter}} + "\nSum of time BOG Current month Problems --> " + {{array_sum($arrayoftime)}} + " Hour")
