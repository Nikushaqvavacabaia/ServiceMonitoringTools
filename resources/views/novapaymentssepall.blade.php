...
<body>
	...
	<script type="text/javascript">
		...
		"/Music/novapayments.mp3"
		);
		<?php 

		$counter=count($monitorings); ?>
		alertAudio.play();
		alert("All Problems of novapayments September --> " + {{$counter}} + "\nSum of time novapayments September Problems --> " + {{array_sum($novapaymentssepall)}} + " Hour")
