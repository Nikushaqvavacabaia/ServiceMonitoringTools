...
<body>
									...
									<td>  
										<?php
											...
											if($date2 < $date1){
												...
												array_push($silknetnovall, $date4);
												echo($date4);
												
											}
											else{
												array_push($silknetnovall, (float)$diff->format("%h.%i"));
	...
	<script type="text/javascript">
		...
		alertAudio.play();
		alert("All Problems of Silknet November --> " + {{$counter}} + "\nSum of time Silknet November Problems --> " + {{array_sum($silknetnovall)}} + " Hour")
