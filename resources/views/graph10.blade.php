...
<br><br><br><br>
		...
		<section id="s-team" class="section">
			...
			<br><br><br>
            <?php 
            $sumofprov=($sumbogoct + $sumtbcoct + $sumoppaoct + $sumipayoct + $sumtbcpayoct + $sumnovapaymentsoct + $sumegtoct + $sumeverymatrixoct + $sumoppaoct + $sumbetconstructoct + $sumbetradaroct + $sumgoldenraceoct + $sumevolutiongamingoct + $sumlambdaoct + $sumigrosoftoct +  $sumsilknetoct + $summagtioct + $sumglobalcelloct + $sumcaucasusoct + $sumlivecalleroct);
            $sumofnetwork=$sumitsupportoct;
            $sumofback=$sumsbbettingoct;
            $sumoffront=$sumfrontoct;
