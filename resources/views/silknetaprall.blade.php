...
<body>
									...
									<td>  
										<?php
											...
											if($date2 < $date1){
												...
												array_push($silknetaprall, $date4);
												echo($date4);
												
											}
											else{
												array_push($silknetaprall, (float)$diff->format("%h.%i"));
	...
	<script type="text/javascript">
		...
		alertAudio.play();
		alert("All Problems of Silknet April --> " + {{$counter}} + "\nSum of time Silknet April Problems --> " + {{array_sum($silknetaprall)}} + " Hour")
